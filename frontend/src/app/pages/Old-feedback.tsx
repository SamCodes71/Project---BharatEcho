      ...
      <Dialog open={showAdd} onOpenChange={setShowAdd}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Manually create a feedback request for a citizen
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 pt-2">
            ...
            <div>
              <label className="text-sm font-medium text-slate-700">Complaint ID</label>
              <Input
                className="mt-1"
                placeholder="e.g. CMP-2025-AB12"
                value={form.complaint_id}
                onChange={(e) => setForm((p) => ({ ...p, complaint_id: e.target.value }))}
              />
            </div>
            <div>
